<section class="py-24 bg-[#F2FBF7]">
  <div class="container-custom text-center">
    <!-- Logos -->
    <div class="flex items-center justify-center gap-12 mb-12 opacity-50 grayscale">
        <span class="font-black text-xl tracking-tighter">VAPI</span>
        <span class="font-mono font-bold text-xl tracking-widest">CURSOR</span>
        <span class="font-serif font-bold text-xl italic">Default</span>
    </div>
